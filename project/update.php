...
<?php
    ...
    $mhs = query("SELECT * FROM community WHERE id=$id")[0];
    // var_dump($mhs);
?>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-2 col-md-push-5 text-center">
                            <div id="colorlib-logo"><a href="index.html"><i class="icon-camera4"></i>MC_MOTRET</a></div>
                        </div>
